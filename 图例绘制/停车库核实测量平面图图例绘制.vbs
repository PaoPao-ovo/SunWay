...
Function DrawTuLi()
	...
	SSProcess.SetSelectCondition "SSObj_Code", "==", 9460093 '图廓
	...
	GeoCount = SSProcess.GetSelGeoCount()
		If Geocount>0 Then 
			...
			Next
			innerids=SSProcess.SearchInnerObjIDs(ID , 10 ,"9460081,9460033,9460003,9450013", 0)
			If innerids<>"" Then 
...
Function DrawInner(x,y,polygonID,ZDrawCode,ZDrawColor,ZDrawName)
	...
	If arDrawCode(i)=9460033  Then 
		...
		DrawNote x-13,y+3*(count-3-i)+3,arDrawCode(i),arDrawColor(i),FountWith,FountHight,"室外非机动车位",polygonID
	End If
...
Function DrawBorder(x,y,code,color,polygonID,count)
	...
	'内框线
	SSProcess.AddNewObjPoint x, y, 0, 0, ""
	SSProcess.AddNewObjPoint x, y+30 , 0, 0, ""
	SSProcess.AddNewObjPoint x-60, y+30 , 0, 0, ""
	SSProcess.AddNewObjPoint x-60, y , 0, 0, ""
	SSProcess.AddNewObjPoint x, y, 0, 0, ""
	
	'外框线
	SSProcess.AddNewObjPoint x, y, 0, 0, ""
	SSProcess.AddNewObjPoint x, y+31 , 0, 0, ""
	SSProcess.AddNewObjPoint x-61, y+31 , 0, 0, ""
	SSProcess.AddNewObjPoint x-61, y , 0, 0, ""
	SSProcess.AddNewObjPoint x, y, 0, 0, ""
	SSProcess.AddNewObjToSaveObjList
	SSProcess.SaveBufferObjToDatabase
