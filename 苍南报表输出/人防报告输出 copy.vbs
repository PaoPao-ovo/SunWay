...
Function InsertSm(ByVal StartRow,ByVal EndRow,ByVal RfCount,ByVal Yjmj,ByVal SPYJmj)
    ...
    If (Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - SPYJmj) >= 0 Then
        Replace4 = "实际超面积" & Round(Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - SPYJmj,2)
    Else
        Replace4 = "实际小于面积" & Abs(Round(Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - SPYJmj,2))
    End If
    ...
    If (Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - Yjmj) >= 0 Then
        Replace6 = "实际超面积" & Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - Yjmj
    Else
        Replace6 = "实际小于面积" & Abs(Transform(GetSelCellVal(Global_Word.GetCellText(2,EndRow + 1,2,False))) - Yjmj)
    End If
